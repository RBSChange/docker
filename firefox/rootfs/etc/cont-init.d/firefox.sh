...
#test ! -f "/config/profile/extensions/{60e116b0-f84c-11dd-87af-0800200c9a66}.xpi" && {
#    #mkdir -p "/config/profile/extensions"
#    #cp /rbs-change-manager.xpi -d "/config/profile/extensions/{60e116b0-f84c-11dd-87af-0800200c9a66}.xpi"
#}
